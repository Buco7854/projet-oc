...
class HybridACOQLSolver:
    ...
    def solve(self, callback=None) -> CVRPSolution:
        ...
        for iteration in range(max_iter):
            ...
            # Choisir et appliquer une stratégie (après le warm-up)
            apply_2opt = False
            if iteration >= warmup:
            ...
            # Calculer métriques et récompense
            ...
            # Observer le nouvel état et mettre à jour Q
